...
- Document current browser rendering and accessibility behavior.
- Publish both browser packages for coordinated release 0.13.3.

## [0.13.2] - 2026-09-13

### Changed

- Qualify full-grid canvas clipping cost and document fallback glyph behavior.
- Publish both browser packages for coordinated release 0.13.2.

## [0.13.1] - 2026-09-12

### Changed

- Publish both browser packages for coordinated release 0.13.1. Browser package
  behavior is unchanged from 0.13.0.

## [0.13.0] - 2026-09-10

### Changed

- Publish both browser packages for coordinated release 0.13.0. Browser package behavior is unchanged.
...
[0.13.0]: https://github.com/SwiftTUI/swift-tui-web/releases/tag/0.13.0

[0.13.1]: https://github.com/SwiftTUI/swift-tui-web/releases/tag/0.13.1
