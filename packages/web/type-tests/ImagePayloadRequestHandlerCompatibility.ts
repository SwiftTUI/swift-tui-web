...
import type { CanvasSurfacePainterOptions } from "../dist/testing.js";

const requests: string[][] = [];

const legacyHandler: WebHostImagePayloadRequestHandler = (ids) =>
  requests.push([...ids]);

const admissionAwareHandler: WebHostImagePayloadRequestHandler = (ids) =>
  ids.filter((id) => id.startsWith("png:"));
...
type ImagePayloadRequestResult = ReturnType<WebHostImagePayloadRequestHandler>;
