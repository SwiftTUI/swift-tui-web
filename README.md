...
> Status: `0.4.1` beta — source-breaking changes may land before 1.0.
...
```bash
npm install \
  https://github.com/SwiftTUI/swift-tui-web/releases/download/0.4.1/swifttui-web-0.4.1.tgz \
  https://github.com/SwiftTUI/swift-tui-web/releases/download/0.4.1/swifttui-build-0.4.1.tgz
```
