...
> Status: `0.7.1` beta. Source-breaking changes can occur before 1.0.
...
```bash
npm install \
  https://github.com/SwiftTUI/swift-tui-web/releases/download/0.7.1/swifttui-web-0.7.1.tgz \
  https://github.com/SwiftTUI/swift-tui-web/releases/download/0.7.1/swifttui-build-0.7.1.tgz
```
