...
> Status: `0.8.7` beta. Source-breaking changes can occur before 1.0.
...
```bash
npm install \
  https://github.com/SwiftTUI/swift-tui-web/releases/download/0.8.7/swifttui-web-0.8.7.tgz \
  https://github.com/SwiftTUI/swift-tui-web/releases/download/0.8.7/swifttui-build-0.8.7.tgz
```
