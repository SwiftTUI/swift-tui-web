...
> Status: `0.8.0` beta. Source-breaking changes can occur before 1.0.
...
```bash
npm install \
  https://github.com/SwiftTUI/swift-tui-web/releases/download/0.8.0/swifttui-web-0.8.0.tgz \
  https://github.com/SwiftTUI/swift-tui-web/releases/download/0.8.0/swifttui-build-0.8.0.tgz
```
