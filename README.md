...
```bash
npm install \
  https://github.com/SwiftTUI/swift-tui-web/releases/download/0.4.6/swifttui-web-0.4.6.tgz \
  https://github.com/SwiftTUI/swift-tui-web/releases/download/0.4.6/swifttui-build-0.4.6.tgz
```
