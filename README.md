...
> Status: `0.1.6` beta — source-breaking changes may land before 1.0.
...
```bash
npm install \
  https://github.com/SwiftTUI/swift-tui-web/releases/download/0.1.6/swifttui-web-0.1.6.tgz \
  https://github.com/SwiftTUI/swift-tui-web/releases/download/0.1.6/swifttui-build-0.1.6.tgz
```
