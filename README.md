...
> Status: `0.1.2` beta — source-breaking changes may land before 1.0.
...
```bash
npm install \
  https://github.com/SwiftTUI/swift-tui-web/releases/download/0.1.2/swifttui-web-0.1.2.tgz \
  https://github.com/SwiftTUI/swift-tui-web/releases/download/0.1.2/swifttui-build-0.1.2.tgz
```
