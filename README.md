...
```bash
npm install \
  https://github.com/SwiftTUI/swift-tui-web/releases/download/0.15.1/swifttui-web-0.15.1.tgz \
  https://github.com/SwiftTUI/swift-tui-web/releases/download/0.15.1/swifttui-build-0.15.1.tgz
```
