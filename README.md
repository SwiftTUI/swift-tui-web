...
```bash
npm install \
  https://github.com/SwiftTUI/swift-tui-web/releases/download/0.13.4/swifttui-web-0.13.4.tgz \
  https://github.com/SwiftTUI/swift-tui-web/releases/download/0.13.4/swifttui-build-0.13.4.tgz
```
