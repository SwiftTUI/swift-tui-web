...
> Status: `0.8.9` beta. Source-breaking changes can occur before 1.0.
...
```bash
npm install \
  https://github.com/SwiftTUI/swift-tui-web/releases/download/0.8.9/swifttui-web-0.8.9.tgz \
  https://github.com/SwiftTUI/swift-tui-web/releases/download/0.8.9/swifttui-build-0.8.9.tgz
```
