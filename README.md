...
> Status: `0.9.4` beta. Source-breaking changes can occur before 1.0.
...
```bash
npm install \
  https://github.com/SwiftTUI/swift-tui-web/releases/download/0.9.4/swifttui-web-0.9.4.tgz \
  https://github.com/SwiftTUI/swift-tui-web/releases/download/0.9.4/swifttui-build-0.9.4.tgz
```
